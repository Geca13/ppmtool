...
class AddProjectTask extends Component {
    ...
    onSubmit(e){
        ...
        this.props.addProjectTask(this.state.identifier, newTask, this.props.history)
    }
            ...
            <div className="row">
                <div className="col-md-8 m-auto">
                    ...
                    <form onSubmit={this.onSubmit} >
                        ...
                        <div className="form-group">
                            <textarea className="form-control form-control-lg" placeholder="Acceptance Criteria" name="acceptanceCreteria" value={this.state.acceptanceCriteria} onChange={this.onChange}></textarea>
                        </div>
                        <h6>Due Date</h6>
                        <div className="form-group">
...
export default connect(mapStateToMaps, {addProjectTask}) (AddProjectTask);